    ...
    <div className="space-y-6">
      ...
      <Panel>
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <Field label="Course code" error={errors.code} required><input value={values.code} onChange={(event) => update("code", event.target.value)} className={fieldClass} disabled={readOnly} placeholder="PHY-12-COMP" autoCapitalize="characters" /></Field>
