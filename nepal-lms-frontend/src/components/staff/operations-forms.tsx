...
export function CreateStudentForm() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    }catch(error){const message=getError(error,"The request could not be completed.");setNotice({tone:"danger",title:"Student not created",message});toast({tone:"danger",title:"Student not created",message});}
