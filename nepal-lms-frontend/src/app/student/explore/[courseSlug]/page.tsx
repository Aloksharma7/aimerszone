      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_370px]">
        <div className="space-y-6">
          <Panel className="overflow-hidden p-0" padded={false}>
            <div className="relative aspect-[16/7] min-h-56 bg-slate-100">
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 text-white sm:p-7">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-100">{course.description}</p>
              </div>
            </div>
          </Panel>
          ...
          <Panel>
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-slate-200 p-4"><GraduationCap className="h-5 w-5 text-brand-700" /><p className="mt-3 text-lg font-bold text-slate-950">{course.teacher}</p><p className="mt-1 text-sm text-slate-500">Faculty</p></div>
            </div>
          </Panel>
        </div>
        ...
        <aside>
          <Panel className="sticky top-24">
            ...
            <h2 className="mt-2 text-lg font-bold text-slate-950">{course.batch}</h2>
