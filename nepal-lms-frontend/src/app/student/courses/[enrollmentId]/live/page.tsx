  ...
  return (
    <>
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 rounded-xl border border-blue-200 bg-blue-50 p-4 text-sm leading-6 text-blue-900"><Info className="mt-0.5 h-5 w-5 shrink-0" />The Join button calls an authorised Laravel endpoint. The server verifies enrollment, access expiry and joining time before returning a short-lived meeting link.</div>
