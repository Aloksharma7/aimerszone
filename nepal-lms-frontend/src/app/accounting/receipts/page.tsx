  ...
  return (
    <>
      ...
      <Panel className="mt-6">
        <ListFilters searchValue={q} searchPlaceholder="Search receipt, payment or student" resetHref="/accounting/receipts" fields={[{ name: "status", label: "Receipt status", value: status, options: [{ value: "", label: "All statuses" }, { value: "Issued", label: "Issued" }, { value: "Adjusted", label: "Adjusted" }, { value: "Voided", label: "Voided" }] }]} />
