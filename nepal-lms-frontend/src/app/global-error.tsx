      ...
      <body>
        <main className="flex min-h-screen items-center justify-center bg-canvas px-4 py-12">
          <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-8 text-center shadow-card sm:p-10">
            ...
            <p className="mt-3 text-base leading-7 text-slate-600">This isn&apos;t something you did — try again in a moment. If it keeps happening, contact support and share the code below so we can look into it.</p>
            {error.digest ? <p className="mt-3 rounded-lg bg-slate-50 px-3 py-2 font-mono text-xs text-slate-500">Support code: {error.digest}</p> : null}
