...
export async function getAdminSettings(): Promise<AdminSettingsData> {
  if (isMockDataEnabled()) return {
    institution: { name: "Aimers Zone", shortName: "Aimers Zone", tagline: "Live classes, recordings, tests and support in one clear place.", primaryPhone: "+977 98XXXXXXXX", supportEmail: "support@example.com", whatsapp: "97798XXXXXXXX", website: "https://aimerszone.edu.np", address: "Kathmandu, Nepal", logoUrl: null, faviconUrl: null },
