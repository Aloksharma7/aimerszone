          ...
          <View className="gap-4">
            ...
            <View>
              <FormField
                ...
                editable={!submitting}
              />
              <Pressable onPress={() => router.push("/(auth)/forgot-password")} className="mt-2 self-end">
            ...
            >
              {submitting ? <ActivityIndicator color="#fff" /> : <Text className="text-base font-bold text-white">Sign in</Text>}
            </Pressable>
          </View>
        </View>

        <Pressable onPress={() => router.push("/(auth)/register")} className="mt-6 h-11 items-center justify-center">
