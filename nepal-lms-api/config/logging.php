...
return [
    ...
    'channels' => [
        ...
        // Security-relevant events kept separate from application noise.
        'security' => ['driver' => 'daily', 'path' => storage_path('logs/security.log'), 'level' => 'info', 'days' => 90, 'replace_placeholders' => true],
        'integrations' => ['driver' => 'daily', 'path' => storage_path('logs/integrations.log'), 'level' => 'info', 'days' => 30, 'replace_placeholders' => true],
